...
def main(
    ...
    config = OmegaConf.load(f"configs/config_visplotbench.yaml") if config_file is None else OmegaConf.load(config_file)
    config.run_mode = "normal" if run_mode is None else run_mode
